  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await onSuccess({
        ...
        farmer_name: locationForm.farmerName,
        farmer_id: locationForm.farmerID,
        crop_type: locationForm.cropType,
      ...
      setSuccess('✅ Farm location added successfully!');
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[9999] p-4">
      <div className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[95vh] overflow-y-auto">
        <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 flex justify-between items-center rounded-t-2xl z-10">
          <h2 className="text-2xl font-bold text-gray-800">📍 Add Farm Location</h2>
          <button
            onClick={onClose}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                placeholder="e.g., Bugema Crop Farm"
              />
            </div>
            ...
            <div>
              ...
              <input
                type="text"
                required
                value={locationForm.farmerName}
                onChange={(e) => setLocationForm({ ...locationForm, farmerName: e.target.value })}
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
            ...
            <div>
              ...
              <input
                type="text"
                required
                value={locationForm.cropType}
                onChange={(e) => setLocationForm({ ...locationForm, cropType: e.target.value })}
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
                placeholder="e.g., Maize, Coffee, etc."
              />
            </div>
